...
-------------------------------------------------------------------------------------------------------------
 ...
 function SetButtonON(sec, cmd)
    ...
    reaper.SetExtState("ReaVolution", "Default override", "1", true)
...
function SetButtonOFF(sec, cmd)
    ...
    reaper.SetExtState("ReaVolution", "Default override", "0", true)
    reaper.RefreshToolbar2( sec, cmd )
  end

function main()
    local state =  tonumber(reaper.GetExtState( "ReaVolution", "Default override" ))
