...
-------------------------------------------------------------------------------------------------------------
 ...
 function SetButtonON(sec, cmd)
    ...
    reaper.SetExtState("ReaVolution", "Send_CreateObjectTracks", "1", true)
...
function SetButtonOFF(sec, cmd)
    ...
    reaper.SetExtState("ReaVolution", "Send_CreateObjectTracks", "0", true)
    reaper.RefreshToolbar2( sec, cmd )
  end

function main()
    local state =  tonumber(reaper.GetExtState( "ReaVolution", "Send_CreateObjectTracks" ))
